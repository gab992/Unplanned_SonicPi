...
define :improv_E do
  use_synth :chiplead
  play choose([:E5,:Gs5,:B5,:Ds5,:E6,:Gs6,:B6,:Ds6]), attack:0, release:0.2, pan:synth_pan
end

define :improv_A do
  use_synth :chiplead
  play choose([:A5,:C5,:E5,:G5,:A6,:C6,:E6,:G6]), attack:0, release:0.2, pan:synth_pan
end

define :improv_F do
  use_synth :chiplead
  play choose([:Fs5,:A5,:Cs5,:E5,:Fs6,:A6,:Cs6,:E6]), attack:0, release:0.2, pan:synth_pan
end

define :improv_G do
  use_synth :chiplead
  play choose([:G5,:B5,:D5,:E5,:G6,:B6,:D6,:E6]), attack:0, release:0.2, pan:synth_pan
end
...
6.times do
  ...
  in_thread do
    if one_in(acomp)
      use_synth :piano
      play choose([:E3,:E4,:Gs4,:Gs5,:Ds4,:Ds5,:B3,:B4,:B5]), pan:piano_pan
      play choose([:E3,:E4,:Gs4,:Gs5,:Ds4,:Ds5,:B3,:B4,:B5]), pan:piano_pan
      if one_in(acomp)
        sleep temp/3
        play choose([:E3,:E4,:Gs4,:Gs5,:Ds4,:Ds5,:B3,:B4,:B5]), pan:piano_pan
  ...
  in_thread do
    if one_in(acomp)
      use_synth :piano
      play choose([:A3,:A4,:C3,:C4,:C5,:E3,:E4,:E5,:G4,:G5]), pan:piano_pan
      play choose([:A3,:A4,:C3,:C4,:C5,:E3,:E4,:E5,:G4,:G5]), pan:piano_pan
      if one_in(acomp)
        sleep temp/3
        play choose([:A3,:A4,:C3,:C4,:C5,:E3,:E4,:E5,:G4,:G5]), pan:piano_pan
  ...
  in_thread do
    if one_in(acomp)
      use_synth :piano
      play choose([:Fs3,:Fs4,:A3,:A4,:A5,:Cs3,:Cs4,:Cs5,:E4,:E5]), pan:piano_pan
      play choose([:Fs3,:Fs4,:A3,:A4,:A5,:Cs3,:Cs4,:Cs5,:E4,:E5]), pan:piano_pan
      if one_in(acomp)
        sleep temp/3
        play choose([:Fs3,:Fs4,:A3,:A4,:A5,:Cs3,:Cs4,:Cs5,:E4,:E5]), pan:piano_pan
  ...
  in_thread do
    if one_in(acomp)
      use_synth :piano
      play choose([:G3,:G4,:B3,:B4,:B5,:D3,:D4,:D5,:E4,:E5]), pan:piano_pan
      play choose([:G3,:G4,:B3,:B4,:B5,:D3,:D4,:D5,:E4,:E5]), pan:piano_pan
      if one_in(acomp)
        sleep temp/3
        play choose([:G3,:G4,:B3,:B4,:B5,:D3,:D4,:D5,:E4,:E5]), pan:piano_pan
